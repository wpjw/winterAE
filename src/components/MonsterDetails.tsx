...
const MonsterDetails: React.FC<MonsterDetailsProps> = ({ monster }) => {
    return (
        <div className="monster-details">
            <h3>{monster.name}</h3>
            {monster.type && <p><strong>Type:</strong> {monster.type}</p>}
            {monster.size && <p><strong>Size:</strong> {monster.size}</p>}
            {monster.alignment && <p><strong>Alignment:</strong> {monster.alignment}</p>}
            {Boolean(monster.armor_class) && <p><strong>Armor Class:</strong> {monster.armor_class}</p>}
            {Boolean(monster.hit_points) && <p><strong>Hit Points:</strong> {monster.hit_points}</p>}
            ...
            {Boolean(monster.intelligence) && <p><strong>Intelligence:</strong> {monster.intelligence}</p>}
            {Boolean(monster.wisdom) && <p><strong>Wisdom:</strong> {monster.wisdom}</p>}
            {Boolean(monster.charisma) && <p><strong>Charisma:</strong> {monster.charisma}</p>}
            ...
            {monster.legendary_desc && <p><strong>Legendary Description:</strong> {monster.legendary_desc}</p>}
